    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <div>
            <div style={{ font: 'var(--ab-text-eyebrow)', letterSpacing: '0.14em', textTransform: 'uppercase', color: 'rgba(250,247,242,0.5)' }}>Tour 3D</div>
            <div style={{ font: 'var(--ab-text-h4)' }}>Casa Sonora · Roma Norte</div>
          </div>
        </div>
      ...
      <div style={{ flex: 1, display: 'flex', padding: 24, gap: 16, minHeight: 0 }}>
          ...
          {[
            ...
            <div key={i} style={{
              ...
              <div style={{
                ...
                <div style={{ width: 10, height: 10, borderRadius: 999, background: 'var(--ab-terracotta-500)' }}/>
              </div>
              <div style={{
                position: 'absolute', left: '50%', top: 'calc(100% + 6px)', transform: 'translateX(-50%)',
                whiteSpace: 'nowrap', font: 'var(--ab-text-caption)', fontWeight: 600,
        ...
        <aside style={{
          ...
          <div style={{ font: 'var(--ab-text-eyebrow)', letterSpacing: '0.14em', textTransform: 'uppercase', color: 'rgba(250,247,242,0.5)' }}>Habitaciones</div>
          <div style={{ marginTop: 14, display: 'flex', flexDirection: 'column', gap: 4 }}>
            {[
              ...
              <div key={i} style={{
                ...
                <span>{n}</span>
                <span style={{ fontFamily: 'var(--ab-font-mono)', fontSize: 12 }}>{s}</span>
              </div>
            ))}
          </div>
        </aside>
...
function SegBtn({ active, onClick, children }) {
  return (
    <button onClick={onClick} style={{
      ...
      background: active ? '#FAF7F2' : 'transparent', color: active ? 'var(--ab-ink-900)' : '#FAF7F2',
