    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <div>
            <div style={{ font: 'var(--ab-text-eyebrow)', letterSpacing: '0.14em', textTransform: 'uppercase', color: 'rgba(250,247,242,0.6)' }}>Vista 360°</div>
            <div style={{ font: 'var(--ab-text-h4)' }}>Sala · arrastra para mirar alrededor</div>
          </div>
        </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          color: '#FAF7F2', fontFamily: 'var(--ab-font-mono)', fontSize: 12,
        }}>
          ...
          <div style={{ width: 200, height: 4, background: 'rgba(250,247,242,0.15)', borderRadius: 2, position: 'relative' }}>
            <div style={{ position: 'absolute', left: `${angle}%`, top: -3, width: 10, height: 10, borderRadius: 999, background: 'var(--ab-terracotta-500)', transform: 'translateX(-50%)' }}/>
          </div>
        ...
        <div style={{ display: 'flex', gap: 8 }}>
          {['Sala', 'Cocina', 'Recámara', 'Baño', 'Roof'].map((r, i) => (
            <button key={i} style={{
              ...
              background: i === 0 ? 'var(--ab-terracotta-500)' : 'rgba(22,20,15,0.5)',
